...
#define SM_POWER_EXTERNAL_IMMEDIATE "Внешний прирост энергии"
/// How much energy we get from external factors that are applied over time.
#define SM_POWER_EXTERNAL_TRICKLE "Постепенный внешний приток энергии"
/// How much energy is gained from the temperature. Enabled by gas.
#define SM_POWER_HEAT "Прирост энергии от нагрева газа"
...
#define SM_POWER_POWERLOSS "Внутреннее рассеивание энергии"
...
#define SM_POWER_POWERLOSS_GAS "Снижение рассеивания газом"
/// How much of the energy the SM loses is recouped. From the psychologist this time.
/// Order matters here. We depend on the powerloss amount.
#define SM_POWER_POWERLOSS_SOOTHED "Снижение рассеивания психологом"
