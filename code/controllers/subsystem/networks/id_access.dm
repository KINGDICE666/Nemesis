...
/datum/controller/subsystem/id_access/proc/setup_access_descriptions()
	desc_by_access[ACCESS_CARGO] = "Грузовой отсек"
	desc_by_access[ACCESS_SECURITY] = "Служба безопасности"
	desc_by_access[ACCESS_BRIG] = "Камеры содержания"
	desc_by_access[ACCESS_COURT] = "Зал суда"
	desc_by_access[ACCESS_DETECTIVE] = "Офис детектива"
	desc_by_access[ACCESS_MEDICAL] = "Медицина"
	desc_by_access[ACCESS_GENETICS] = "Лаборатория генетики"
	desc_by_access[ACCESS_MORGUE] = "Морг"
	desc_by_access[ACCESS_MORGUE_SECURE] = "Коронер"
	desc_by_access[ACCESS_SCIENCE] = "Лаборатория НИО"
	desc_by_access[ACCESS_ORDNANCE] = "Лаборатория боеприпасов"
	desc_by_access[ACCESS_ORDNANCE_STORAGE] = "Склад боеприпасов"
	desc_by_access[ACCESS_PLUMBING] = "Химическая лаборатория"
	desc_by_access[ACCESS_RD] = "Офис НР"
	desc_by_access[ACCESS_BAR] = "Бар"
	desc_by_access[ACCESS_JANITOR] = "Кладовая уборщика"
	desc_by_access[ACCESS_ENGINEERING] = "Инженерия"
	desc_by_access[ACCESS_ENGINE_EQUIP] = "Энергетическое и инженерное оборудование"
	desc_by_access[ACCESS_MAINT_TUNNELS] = "Технические тоннели"
	desc_by_access[ACCESS_EXTERNAL_AIRLOCKS] = "Внешние шлюзы"
	desc_by_access[ACCESS_CHANGE_IDS] = "Консоль ID"
	desc_by_access[ACCESS_AI_UPLOAD] = "Помещения ИИ"
	desc_by_access[ACCESS_TELEPORTER] = "Телепортер"
	desc_by_access[ACCESS_EVA] = "EVA"
	desc_by_access[ACCESS_BUDGET] = "Бюджет отдела"
	desc_by_access[ACCESS_COMMAND] = "Командование"
	desc_by_access[ACCESS_CAPTAIN] = "Капитан"
	desc_by_access[ACCESS_ALL_PERSONAL_LOCKERS] = "Личные шкафчики"
	desc_by_access[ACCESS_CHAPEL_OFFICE] = "Офис часовни"
	desc_by_access[ACCESS_TECH_STORAGE] = "Технический склад"
	desc_by_access[ACCESS_ATMOSPHERICS] = "Атмосферика"
	desc_by_access[ACCESS_CREMATORIUM] = "Крематорий"
	desc_by_access[ACCESS_ARMORY] = "Оружейная"
	desc_by_access[ACCESS_CONSTRUCTION] = "Строительная зона"
	desc_by_access[ACCESS_KITCHEN] = "Кухня"
	desc_by_access[ACCESS_HYDROPONICS] = "Гидропоника"
	desc_by_access[ACCESS_LIBRARY] = "Библиотека"
	desc_by_access[ACCESS_LAWYER] = "Юридический офис"
	desc_by_access[ACCESS_ROBOTICS] = "Робототехника"
	desc_by_access[ACCESS_VIROLOGY] = "Вирусология"
	desc_by_access[ACCESS_PSYCHOLOGY] = "Психология"
	desc_by_access[ACCESS_CMO] = "Офис ГВ"
	desc_by_access[ACCESS_PARAMEDIC] = "Офис парамедика"
	desc_by_access[ACCESS_QM] = "Офис КМа"
	desc_by_access[ACCESS_SURGERY] = "Хирургия"
	desc_by_access[ACCESS_THEATRE] = "Театр"
	desc_by_access[ACCESS_RESEARCH] = "Наука"
	desc_by_access[ACCESS_MINING] = "Шахтерский док"
	desc_by_access[ACCESS_SHIPPING] = "Отгрузка снабжения"
	desc_by_access[ACCESS_VAULT] = "Главное хранилище"
	desc_by_access[ACCESS_MINING_STATION] = "Шахтерский аванпост"
	desc_by_access[ACCESS_XENOBIOLOGY] = "Лаборатория ксенобиологии"
	desc_by_access[ACCESS_HOP] = "Офис ГП"
	desc_by_access[ACCESS_HOS] = "Офис ГСБ"
	desc_by_access[ACCESS_CE] = "Офис СИ"
	desc_by_access[ACCESS_PHARMACY] = "Аптека"
	desc_by_access[ACCESS_RC_ANNOUNCE] = "Объявления РЦ"
	desc_by_access[ACCESS_KEYCARD_AUTH] = "Авторизация ключ-картой"
	desc_by_access[ACCESS_TCOMMS] = "Телекоммуникации"
	desc_by_access[ACCESS_GATEWAY] = "Врата"
	desc_by_access[ACCESS_BRIG_ENTRANCE] = "Бриг"
	desc_by_access[ACCESS_MINERAL_STOREROOM] = "Склад минералов"
	desc_by_access[ACCESS_MINISAT] = "Спутник ИИ"
	desc_by_access[ACCESS_WEAPONS] = "Разрешение на оружие"
	desc_by_access[ACCESS_NETWORK] = "Сетевой доступ"
	desc_by_access[ACCESS_MECH_MINING] = "Доступ к шахтерским мехам"
	desc_by_access[ACCESS_MECH_MEDICAL] = "Доступ к медицинским мехам"
	desc_by_access[ACCESS_MECH_SECURITY] = "Доступ к мехам СБ"
	desc_by_access[ACCESS_MECH_SCIENCE] = "Доступ к научным мехам"
	desc_by_access[ACCESS_MECH_ENGINE] = "Доступ к инженерным мехам"
	desc_by_access[ACCESS_AUX_BASE] = "Вспомогательная база"
	desc_by_access[ACCESS_SERVICE] = "Сервисный коридор"
	desc_by_access[ACCESS_CENT_GENERAL] = "Общий доступ ЦК"
	desc_by_access[ACCESS_CENT_THUNDER] = "Тандердом ЦК"
	desc_by_access[ACCESS_CENT_STORAGE] = "Склад ЦК"
	desc_by_access[ACCESS_CENT_LIVING] = "Жилые помещения ЦК"
	desc_by_access[ACCESS_CENT_MEDICAL] = "Медицинский отдел ЦК"
	desc_by_access[ACCESS_CENT_TELEPORTER] = "Телепортер ЦК"
	desc_by_access[ACCESS_CENT_SPECOPS] = "Спецоперации ЦК"
	desc_by_access[ACCESS_CENT_CAPTAIN] = "Капитан ЦК"
	desc_by_access[ACCESS_CENT_BAR] = "Бар ЦК"
	desc_by_access[ACCESS_CENT_OFFICER] = "Офицер ЦК"
	desc_by_access[ACCESS_BIT_DEN] = "Логово битраннеров"
