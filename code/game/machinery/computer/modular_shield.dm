/obj/machinery/computer/modular_shield
	name = "консоль управления модульным щитом"
	desc = "Используется для удаленного мониторинга и переключения модульных генераторов щита."
...
/obj/machinery/computer/modular_shield/attack_paw(mob/user, list/modifiers)
	balloon_alert(user, "кнопки нажимаются")
