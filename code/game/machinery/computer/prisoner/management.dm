...
/obj/machinery/computer/prisoner/management
	name = "консоль управления заключенными"
	desc = "Используется для изменения ID заключенных и управления имплантами безопасности у осужденных и условно освобожденных."
...
/obj/machinery/computer/prisoner/management/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	...
	switch(action)
		...
		if("set_id_goal")
			var/num = tgui_input_number(usr, "Введите цель заключенного", "Управление заключенными", 100, 1000, 1)
