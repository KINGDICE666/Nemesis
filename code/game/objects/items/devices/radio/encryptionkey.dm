...
/obj/item/encryptionkey/examine(mob/user)
	...
	if(!LAZYLEN(channels) && !(special_channels & RADIO_SPECIAL_BINARY) && !LAZYLEN(language_data))
		. += span_warning("Внутри нет специальных кодов. Вероятно, стоит сообщить разработчику!")
		return

	var/list/examine_text_list = list()
	for(var/i in channels)
		examine_text_list += "[GLOB.channel_tokens[i]] - [LOWER_TEXT(ru_radio_channel_name(i))]"

	if(special_channels & RADIO_SPECIAL_BINARY)
		examine_text_list += "[GLOB.channel_tokens[MODE_BINARY]] - [ru_radio_channel_name(MODE_BINARY)]"

	if(length(examine_text_list))
		. += span_notice("Доступные каналы: [jointext(examine_text_list, ", ")].")
	...
	if(length(language_text_list))
		. += span_notice("Может переводить следующие языки: [jointext(language_text_list, ", ")].")
...
/obj/item/encryptionkey/binary
	name = "ключ бинарного переводчика"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_eng
	name = "ключ шифрования инженерной рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_rob
	name = "ключ шифрования рации робототехники"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_med
	name = "ключ шифрования медицинской рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_sci
	name = "ключ шифрования научной рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_medsci
	name = "ключ шифрования медико-научной рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_srvsec
	name = "ключ шифрования рации закона и порядка"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_srvmed
	name = "ключ шифрования рации психолога"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_srvent
	name = "ключ шифрования рации прессы"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_com
	name = "ключ шифрования командной рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/captain
	name = "\proper ключ шифрования капитана"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/rd
	name = "\proper ключ шифрования научного руководителя"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/hos
	name = "\proper ключ шифрования главы службы безопасности"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/ce
	name = "\proper ключ шифрования старшего инженера"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/cmo
	name = "\proper ключ шифрования главного врача"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/hop
	name = "\proper ключ шифрования главы персонала"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/heads/qm
	name = "\proper ключ шифрования квартирмейстера"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_cargo
	name = "ключ шифрования рации снабжения"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_mining
	name = "ключ шифрования шахтёрской рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_service
	name = "ключ шифрования сервисной рации"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/headset_cent
	name = "\improper ключ шифрования рации ЦК"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
...
/obj/item/encryptionkey/ai/evil //ported from NT, this goes 'inside' the AI.
	name = "бинарный ключ шифрования Синдиката"
	icon = 'icons/map_icons/items/encryptionkey.dmi'
