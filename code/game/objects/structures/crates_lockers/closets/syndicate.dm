...
/obj/structure/closet/syndicate/personal
	desc = "Личный шкаф хранения снаряжения оперативника."
...
/obj/structure/closet/syndicate/nuclear
	desc = "Шкаф хранения снаряжения абордажной группы Синдиката."
...
/obj/structure/closet/syndicate/chemical
	name = "шкаф с химическими припасами"
...
/obj/structure/closet/syndicate/resources/populate_contents_immediate()
	...
	if(pickednum == 1)
		...
		paper.name = "\improper расписка"
		paper.add_raw_text("Прости, нам нужны были деньги, так что мы продали твой тайник. Ничего страшного, в этот раз мы точно удвоим сумму!")
...
/obj/structure/closet/syndicate/resources/everything
	desc = "Аварийный шкаф хранения для ремонта."
