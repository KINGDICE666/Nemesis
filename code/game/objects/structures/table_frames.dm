...
/obj/structure/table_frame
	name = "каркас стола"
	desc = "Четыре металлические ножки и четыре стержня каркаса для стола. Сквозь него легко пройти."
...
/obj/structure/table_frame/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	...
	for(var/obj/object in loc)
		...
		if((object.density && !(object.obj_flags & IGNORE_DENSITY)) || object.obj_flags & BLOCKS_CONSTRUCTION)
			balloon_alert(user, "[object.name] мешает!")
			return ITEM_INTERACT_BLOCKING
...
/obj/structure/table_frame/wood
	name = "деревянный каркас стола"
	desc = "Четыре деревянные ножки и четыре деревянных стержня каркаса для стола. Сквозь него легко пройти."
