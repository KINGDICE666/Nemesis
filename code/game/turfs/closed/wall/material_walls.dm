/turf/closed/wall/material
	name = "стена"
	desc = "Огромный кусок материала, используемый для разделения помещений."
...
/turf/closed/wall/material/finalize_material_effects(list/materials)
	. = ..()
	desc = "Огромный кусок материала ([get_material_english_list(materials)]), используемый для разделения помещений."
