/turf/closed/wall/mineral/cult
	...
	desc = "Холодная металлическая стена, покрытая непонятными символами. От их изучения начинает раскалываться голова."
...
/turf/closed/wall/mineral/cult/artificer
	...
	desc = "Холодная каменная стена, покрытая непонятными символами. От их изучения начинает раскалываться голова."
...
/turf/closed/wall/mineral/bronze
	name = "заводная стена"
	desc = "Огромный кусок бронзы, украшенный шестернями и зубцами."
...
/turf/closed/wall/rock
	name = "укреплённая порода"
	desc = "В ней есть металлические распорки, которые нужно срезать сваркой перед добычей."
...
/turf/closed/wall/rock/porous
	name = "укреплённая пористая порода"
	desc = "Эта порода наполнена карманами пригодного для дыхания воздуха. Металлические распорки защищают её от добычи."
...
/turf/closed/wall/tomb
	name = "стена гробницы"
	desc = "Резная поверхность пыльной гробницы. Непонятно, кто её построил."
