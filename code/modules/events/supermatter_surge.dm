...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("Система мониторинга целостности кристалла обнаружила необычные атмосферные свойства в камере суперматерии. Энерговыход кристалла суперматерии значительно увеличился. Для стабилизации двигателя требуется вмешательство инженерного отдела.", "Предупреждение о всплеске суперматерии класса [class_to_announce]", 'sound/machines/engine_alert/engine_alert3.ogg')
...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("Всплеск суперматерии рассеялся, показатели выхода кристалла нормализовались.", "Аномалия устранена")
	engine = null
	sm_gas = null

/datum/round_event_control/supermatter_surge/poly
	name = "Всплеск суперматерии: месть Поли"
...
/datum/round_event/supermatter_surge/poly/announce(fake)
	priority_announce("Система мониторинга целостности кристалла обнаружила необычный резонанс попугайного типа в камере суперматерии. Энерговыход кристалла суперматерии значительно увеличился. Для стабилизации двигателя требуется вмешательство инженерного отдела.", "Предупреждение о всплеске суперматерии класса P", 'sound/machines/engine_alert/engine_alert3.ogg')
