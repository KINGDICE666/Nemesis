...
/datum/techweb_node/cybernetics
	...
	description = "Разумные роботы с предустановленными модулями инструментов и программируемыми законами."
...
/datum/techweb_node/borg_service
	...
	display_name = "Сервисные улучшения киборгов"
	description = "Пусть готовят строго по книге."
...
/datum/techweb_node/borg_mining
	...
	display_name = "Шахтёрские улучшения киборгов"
	description = "Для добычи там, где людям слишком опасно."
	prereq_ids = list(TECHWEB_NODE_CYBERNETICS)
	design_ids = list(
...
/datum/techweb_node/borg_medical
	...
	display_name = "Медицинские улучшения киборгов"
	description = "Пусть следуют Первому закону Азимова."
...
/datum/techweb_node/borg_utility
	...
	display_name = "Вспомогательные улучшения киборгов"
	description = "Пусть моют полы за нас."
...
/datum/techweb_node/borg_engi
	...
	display_name = "Инженерные улучшения киборгов"
	description = "Чтобы лениться ещё эффективнее."
...
/datum/techweb_node/passive_implants
	...
	description = "Импланты, работающие без активного участия пользователя и улучшающие различные физиологические функции."
	prereq_ids = list(TECHWEB_NODE_AUGMENTATION)
	design_ids = list(
		"skill_station",
		"implant_trombone",
...
/datum/techweb_node/cyber/cyber_implants
	...
	description = "Продвинутые технологические улучшения, встроенные в тело и повышающие физические возможности."
...
/datum/techweb_node/cyber/combat_implants
	...
	description = "Чтобы ты точно смог проснуться, самурай."
...
/datum/techweb_node/cyber/integrated_toolsets
	...
	display_name = "Встроенные наборы инструментов"
	description = "Десятилетия контрабанды ассистентов привели к созданию полноценного ящика инструментов, который аккуратно помещается в руку."
...
/datum/techweb_node/cyber/cyber_organs
	...
	description = "У нас есть технологии, чтобы собрать его заново."
	prereq_ids = list(TECHWEB_NODE_CYBERNETICS)
	design_ids = list(
...
/datum/techweb_node/cyber/cyber_organs_upgraded
	...
	description = "У нас есть технологии, чтобы улучшить его."
...
/datum/techweb_node/cyber/cyber_organs_adv
	...
	description = "Передовые кибернетические органы с усиленными сенсорными возможностями."
