/datum/techweb_node/fundamental_sci
	...
	description = "Закладывает основу научного понимания, открывая путь к более глубоким исследованиям и теоретическим изысканиям."
	design_ids = list(
		"rdserver",
		"rdservercontrol",
		"rdconsole",
...
/datum/techweb_node/bluespace_theory
	...
	display_name = "Теория блюспейса"
	description = "Базовые исследования загадочного альтернативного измерения, известного как блюспейс."
...
/datum/techweb_node/applied_bluespace
	...
	description = "Более глубокое понимание блюспейс-динамики позволяет создавать сложные приложения и технологии на основе данных анализа блюспейс-кристаллов."
...
/datum/techweb_node/bluespace_travel
	...
	display_name = "Блюспейс-перемещение"
	description = "Развитие методов телепортации на основе принципов блюспейса для революционного повышения эффективности логистики."
...
/datum/techweb_node/anomaly_research
	...
	description = "Углублённое изучение загадочных аномалий и методов очищения и применения их непредсказуемых энергий."
	prereq_ids = list(TECHWEB_NODE_APPLIED_BLUESPACE)
	design_ids = list(
		"anomaly_refinery",
		"anomaly_neutralizer",
...
/datum/techweb_node/anomaly_shells
	...
	display_name = "Продвинутые оболочки аномалий"
	description = "Новые оболочки, разработанные для использования ядер аномалий и раскрытия их потенциала инновационными способами."
