...
export const CivCargoHoldTerminal = (props) => {
  ...
  const in_text = 'Добро пожаловать, ценный сотрудник.';
  const out_text = 'Чтобы начать, вставьте ID в консоль.';
        ...
        buttons={
          <>
            ...
            <Button
              ...
              tooltip={sending ? 'Остановить отправку' : 'Отправить груз'}
              selected={sending}
              disabled={!pad || !id_inserted}
            ...
            <Button
              ...
              tooltip={id_bounty_info ? 'Заменить награду' : 'Новая награда'}
...
const BountyTextBox = (props) => {
  ...
  const na_text = 'Н/Д, добавьте новую награду.';
  return (
    <Section title="Информация о награде">
      <LabeledList>
...
const BountyPickBox = (props) => {
  ...
  return (
    <Section title="Выберите награду:" textAlign="center">
      <Flex width="100%" wrap>
...
const BountyPickButton = (props) => {
  return (
    ...
    >
      ...
      <Box>Выплата: {props.bounty_value} cr</Box>
    </Button>
  );
};
        ...
        >
          ...
          >
            ...
            <Tabs.Tab
              ...
              align="center"
              >
              <Tooltip content="Общее число глобальных наград увеличивается на 1 за каждые 3 выполненные!">
                <Box className="Marquee">
                  Выполнено наград: {data.claimed_bounties}{data.claimed_bounties > 0 ? "!" : "."}
                </Box>
              </Tooltip>
            </Tabs.Tab>
          )}
      ...
      <Stack.Item grow>
        {localBounty.reward !== 0 ? (
          ...
          <ProgressBar
            ...
            p={1}
            >
          Отправлено: {localBounty.shipped} / {localBounty.maximum}.
          </ProgressBar>
              <Box
              ...
              <Box
                ...
                color="white"
              >
                <Tooltip content={`Вы получите долю ${Math.round(localBounty.reward * 0.3)} кредитов.`}>
                  <b>Награда:</b> {localBounty.reward} кредитов
                </Tooltip>
            </Box>
          <Button
            width="100%"
