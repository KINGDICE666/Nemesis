      ...
      <Stack.Item grow>
        ...
        >
          <Stack vertical>
            ...
            />
            <SupermatterEntry
              title="Передача энергии разрядов"
              alwaysShowChevron
              content={
                <ProgressBar
            ...
            <SupermatterEntry
              ...
              content={
                ...
                >
                  {`${toFixed(gas_total_moles, 2)} моль`}
                </ProgressBar>
              }
            />
            <SupermatterEntry
        ...
        >
          <Stack vertical>
            {gas_composition.map(([gas_path, amount]) => (
              <SupermatterEntry
                key={gas_path}
                title={getGasFromPath(gas_path)?.label || 'Неизвестно'}
                content={
                  <ProgressBar
