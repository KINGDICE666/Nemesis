    ...
    >
      <LabeledList>
        <LabeledList.Item label="Целостность">
          <p
            title={
              'Разгон позволяет вентиляции преодолевать экстремальные перепады давления. Однако он постепенно повреждает устройство и со временем может вывести его из строя. Чем ниже целостность, тем менее эффективно устройство работает в обычном режиме.'
            }
          >
      ...
      <LabeledList>
        <LabeledList.Item label="Режим">
          ...
          <Button
            ...
            selected={widenet}
            content={widenet ? 'Расширенная зона' : 'Обычная зона'}
            onClick={() =>
              act('widenet', {
                ref: refID,
                val: Number(!widenet),
